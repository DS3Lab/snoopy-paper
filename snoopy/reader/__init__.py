...
from .numpy_array import NumpyArrayConfig, NumpyArrayReader
...
def data_factory(reader_config: ReaderConfig) -> DataWithInfo:
    ...
    elif isinstance(reader_config, NumpyArrayConfig):
        return NumpyArrayReader.read_data(reader_config)
